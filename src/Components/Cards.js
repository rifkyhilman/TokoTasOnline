                            ...
                            <Link to="/Jualan">
                                <Card className="card text-center bg-info" >
                                    ...
                                    <Card.Body className="text-white">
                                        ...
                                        <Button variant="outline-light">Check Out</Button>
                                    </Card.Body>
                                </Card>
                            </Link>
                        </div>
                        ...
                        <div>
                            <Link to="/Jualan">
                                <Card className="card text-center bg-info">
                                    ...
                                    <Card.Body className="text-white">
                                        <Card.Title class="font-weight-bold">ToteBack Putih</Card.Title>
                                        <Card.Text>
                                            IDR 649.900,00
                                        </Card.Text>
                                        <Button variant="outline-light">Check Out</Button>
                        ...
                        <div>
                            <Link to="/Jualan">
                                <Card className="card text-center bg-info">
                                    ...
                                    <Card.Body className="text-white">
                                        <Card.Title class="font-weight-bold">Sepatu High Healls Wanita</Card.Title>
                                        <Card.Text>
                                            IDR 649.900,00
                                        </Card.Text>
                                        <Button variant="outline-light">Check Out</Button>
                        ...
                        <div>
                            <Link to="/Jualan">
                                <Card className="card text-center bg-info">
                                    ...
                                    <Card.Body className="text-white">
                                        <Card.Title class="font-weight-bold">ToteBack Pria / Wanita</Card.Title>
                                        <Card.Text>
                                            IDR 99.900
                                        </Card.Text>
                                        <Button variant="outline-light">Check Out</Button>
                        ...
                        <div className="LastCard">
                            <Link to="/Jualan">
                                <Card className="card text-center bg-info">
                                    ...
                                    <Card.Body className="text-white">
                                        <Card.Title class="font-weight-bold">Jam Tangan</Card.Title>
                                        <Card.Text>
                                            IDR 99.900,00
                                         </Card.Text>
                                        <Button variant="outline-light">Check Out</Button>
